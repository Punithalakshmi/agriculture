  ...
  <div class="page-sidebar-wrapper">
    <div class="page-sidebar navbar-collapse collapse">
      <ul class="page-sidebar-menu page-sidebar-menu-light " data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
        ...
        <?php $menu = array(array('link'=>'category','name'=>'Category','icon'=>'fa-linkedin'),array('link'=>'seller','name'=>'Seller','icon'=>'fa-anchor'),array('link'=>'services_product','name'=>'Services','icon'=>'fa-users'),array('link'=>'plans','name'=>'Plans','icon'=>'fa-sitemap'),array('link'=>'events','name'=>'Events','icon'=>'fa-calendar'),array('link'=>'business','name'=>'Business Ads','icon'=>'fa-briefcase'),array('link'=>'subscription','name'=>'Subscriptions','icon'=>'fa-sitemap'));
