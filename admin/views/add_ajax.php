   ...
   <form id="loginForm" method="" action="" novalidate="novalidate">
      ...
      <div class="col-lg-7">
       <label for="exampleInputEmail1">Company Name</label>
      	<?php echo form_input(['name' => 'company_name', 'id' => 'company_name', 'class' => 'form-control', 'maxlength' => '258', 'tabindex' => '2', 'placeholder' =>'Company Name' ,'value' => set_value('company_name')]); ?> <?php echo form_error('company_name', '<small class="help-block text-danger">&nbsp;', '</small>'); ?>
      	</div>
      </div>
      ...
      <div class="col-lg-7">
       <label for="exampleInputEmail1">Website</label>
      	<?php echo form_input(['name' => 'website', 'id' => 'website', 'class' => 'form-control', 'maxlength' => '258', 'tabindex' => '2', 'placeholder' =>'Website' ,'value' => set_value('website')]); ?> <?php echo form_error('website', '<small class="help-block text-danger">&nbsp;', '</small>'); ?>
      	</div>
      </div>
      ...
      <div class="clearfix"></div>
       <div class="col-md-offset-3 col-md-9">
       								 ...
       								 <button type="button" class="btn green" name="insert-data" id="insert-data" onclick="insertData()">Insert Data</button>
	...
	<form action="/" class="dropzone" id="photoForm">
   </form>
						</div>
					</div>
				</div>
...
<script type="text/javascript">
  ...
  function insertData() {
    ...
    var validate = urlregex.test(website);
    if(validate == false)
   	{
   		alert('Invalidate Url')
   	}
   	
    var url = base_url + 'seller/seller_bio';
