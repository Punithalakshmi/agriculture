...
<div class="container">
  <ul class="nav nav-tabs">
    ...
    <li><a data-toggle="tab" href="#menu1" onclick="edittData()">Seller Services</a></li>
   ...
   <form id="loginForm" method="" action="" novalidate="novalidate">
      ...
      <div class="col-lg-7">
       <label for="exampleInputEmail1">Company Name</label>
      	<?php echo form_input(['name' => 'company_name', 'id' => 'company_name', 'class' => 'form-control', 'maxlength' => '258', 'tabindex' => '2', 'placeholder' =>'Company Name' ,'value' => set_value('company_name',$edit_bio['company_name'])]); ?> <?php echo form_error('company_name', '<small class="help-block text-danger">&nbsp;', '</small>'); ?>
      	</div>
      </div>
       ...
       <div class="form-group">  
            ...
            <?php echo form_textarea(['name' => 'description', 'id' => 'description', 'class' => 'form-control', 'tabindex' => '3', 'value' => set_value('description',$edit_bio['description']), 'rows' => 4, 'cols' => 8, 'tabindex' => '10']); ?> <?php echo form_error('description', '<small class="help-block text-danger">&nbsp;', '</small>'); ?> </div>
        </div>

        <div class="form-group">
      <div class="col-lg-7">
       <label for="exampleInputEmail1">Website</label>
      	<?php echo form_input(['name' => 'website', 'id' => 'website', 'class' => 'form-control', 'maxlength' => '258', 'tabindex' => '2', 'placeholder' =>'Website' ,'value' => set_value('website',$edit_bio['website'])]); ?> <?php echo form_error('website', '<small class="help-block text-danger">&nbsp;', '</small>'); ?>
      	</div>
      </div>
      ...
      <div class="clearfix"></div>
       <div class="col-md-offset-3 col-md-9">
       								 ...
       								 <button type="button" class="btn green" name="insert-data" id="insert-data" onclick="insertData()">Submit</button>
...
<script type="text/javascript">
  ...
  function insertData() {
    ...
    var url = base_url + 'seller/bio_add';

    // AJAX code to send data to php file.
        $.ajax({
            type: "POST",
            url: url,
            data: {company_name:company_name,description:description,website:website,seller_id:seller_id},
