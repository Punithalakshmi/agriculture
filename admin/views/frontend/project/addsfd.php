                  ...
                  <div class="portlet-title">
                   ...
                   <div class="portlet-body form">
                        ...
                        <form action="#" class="mt-repeater form-horizontal" name="add_project" id="add_new_project" method="post">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group <?php echo (form_error('se_email'))?'has-error':'';?>">
                                       ...
                                       <div class="col-md-9">
                                          <input type="text" class="form-control" name="se_email" id="se_email" placeholder="Email" value="<?php echo set_value('email',$editdata['se_email']);?>">
                              ...
                              <div class="row">
                                 <div class="col-md-6">
                                    <div class="form-group">
                                       ...
                                       <div class="col-md-9">
                                          <textarea class="form-control" name="se_addr" id="se_addr" placeholder="Address"><?=$editdata['se_addr'];?></textarea>
                                       </div>
                                    </div>
                                 </div>
                                 <!--/span-->
                           ...
                           <?php
                              if(isset($editdata['rooms']))
                              {
                                $r_name = (isset($editdata['rooms']['room_name']) && is_array($editdata['room_name']))?isset($editdata['room_name']):'';
                           ...
                           <div style="margin-left:20px;">
                              ...
                              if(!isset($editdata['rooms']))
                              {
                                ...
                                ?>
                                  <div data-repeater-item class="mt-repeater-item mt-repeater-cust-item">
                                    ...
                                    <div class="mt-repeater-input mt-repeater-del-btn">
                                      <a href="javascript:;" data-repeater-delete2 class="btn btn-danger mt-repeater-delete room-del hide">
                            ...
                            <div class="mt-repeater-room-dtl">
                             <?php
                                if(isset($editdata['rooms']))
                                {
                                  // $room_arr_ele = array_shift($editdata['rooms']); 
                                  foreach($editdata['rooms'] as $key => $value)
                                  {
                                   ?>
                                    <div data-repeater-item class="mt-repeater-item mt-repeater-cust-item">
                                      <!-- jQuery Repeater Container -->
                                      <div class="mt-repeater-input">
                                        <label class="control-label">Room Name</label>
                                        <br/>
                                        <input class="input-group form-control" size="16" type="text"  name="r_name[]" value="<?php echo $value['room_name']; ?>"/> 
                                      </div>
                                      <div class="mt-repeater-input">
                                        <label class="control-label">Room Number</label>
                                        <br/>                                    
                                        <input class="input-group form-control" size="16" type="text"  name="r_no[]" value="<?php echo $value['room_no']; ?>"/>
                                      </div>                                 
                                      <div class="mt-repeater-input">
                                        <label class="control-label">Room Description</label>
                                        <br/>
                                        <textarea class="form-control" name="r_desc_dtl[]" id="r_desc_dtl"/><?php echo $value['room_desc']; ?></textarea> 
                                      </div>
                                       <div class="mt-repeater-input">
                                          <a href="javascript:;" data-repeater-delete2 class="btn btn-danger mt-repeater-delete room-del">
                                          <i class="fa fa-close"></i> Delete</a>
                                       </div>
                                    </div>  
                                    <?php 
                           ...
                           <h3 class="form-section" style="margin-left:20px;"><strong>Project Milestone</strong></h3>
                            ...
                            <a href="javascript:;" style="margin-left:20px;" data-repeater-create class="btn btn-success mt-repeater-add">
                              ...
                              <div data-repeater-list="group-a" style="margin-left:20px;">
                                 ...
                                 <div data-repeater-item class="mt-repeater-item milestone-div">
                                    <!-- jQuery Repeater Container -->
                                    ...
                                    <div class="mt-repeater-input mt-repeater-del-btn">
                                       <a href="javascript:;" data-repeater-delete class="btn btn-danger mt-repeater-delete mile-del hide">
                                       <i class="fa fa-close"></i> Delete</a>
                                    </div>
                                 </div>
                                 ...
                                 <?php $i=1;$j=0;
                                //  echo "<pre>";
                                // print_r($editdata['milestone']);
                                // echo "</pre>";
                                  if(isset($editdata['milestone']) && count($editdata['milestone'])>0)
                                  { 
                                    // $ml_arr_ele = array_shift($editdata['group-a']); 
                                    foreach($editdata['milestone'] as $key=>$value)
                                    {
                                      ?>
                                        <div data-repeater-item class="mt-repeater-item milestone-div">
                                          <!-- jQuery Repeater Container -->                    
                                          <div class="mt-repeater-input mt-repeater-textarea <?php echo (form_error('group-a['.$i.'][m_name]') && $value['name']=='')?'has-error':'';?>">
                                            <label class="control-label">Milestone Name</label>
                                            <br/>
                                            <input type="text" name="m_name" id="m_name" class="form-control" value="<?php echo set_value('m_name',$value["name"]);?>">
                                            <?php echo (form_error('group-a['.$i.'][m_name]') && $value['name']=='')?form_error('group-a['.$i.'][m_name]'):'';?>
                                          </div>
                                          <div class="mt-repeater-input mt-repeater-textarea">
                                            <label class="control-label">Milestone Description</label>
                                            <br/>
                                            <textarea name="m_desc" id="m_desc" class="form-control" rows="2"><?php echo set_value('m_name',$value["description"]);?></textarea>
                                          </div>
                                          <div class="mt-repeater-input <?php echo (form_error('group-a['.$i.'][m_s_d]'))?'has-error':'';?>">
                                            <label class="control-label">Start Date</label>
                                            <br/>
                                            <input class="input-group form-control form-control-inline date date-picker" size="16" type="text"  name="m_s_d"  value="<?php echo set_value('m_name',$value["start_date"]);?>"/> 
                                          ...
                                          <div class="mt-repeater-input <?php echo (form_error('group-a['.$i.'][m_e_d]'))?'has-error':'';?>">
                                            <label class="control-label">End Date</label>
                                            <br/>
                                            <input class="input-group form-control form-control-inline date date-picker" size="16" type="text" name="m_e_d"  value="<?php echo set_value('m_name',$value["end_date"]);?>"/> 
                                            ...
                                            <select name="m_work_items" id="m_work_items" multiple class="form-control">
                                              <?php
                                                if($value['work_items']!='')
                                                {
                                                  foreach($work_items as $key2=>$value2)
                                                  {
                                                    // $work_item2= implode(',',$value['work_items']);
                                                    $final_work_item2= explode(',',$value['work_items']);
                                          ...
                                          <div class="mt-repeater-input <?php echo ((!isset($value['contractor_id']) || $value['contractor_id']==''))?'has-error':'';?>">
                                             <label class="control-label">Contractor</label>
                                             <br/>
                                             <select name="m_cnt" id="m_cnt" class="form-control">
                                                <?php if(isset($editdata['a_c']) && count($editdata['a_c']) && is_array($editdata['a_c'])):
                                              ...
                                              <?php echo ((!isset($value['contractor_id']) || $value['contractor_id']))?form_error('group-a['.$i.'][m_cnt]'):'';?> 
                                          </div>                                    
                                          <div class="mt-repeater-input">
                                             <a href="javascript:;" data-repeater-delete class="btn btn-danger mt-repeater-delete mile-del hide">
                                             <i class="fa fa-close"></i> Delete</a>
