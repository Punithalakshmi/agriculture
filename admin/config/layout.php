...
$config['layout']['default']['stylesheets'] = array('bootstrap.min','font-awesome.min','components','layout','darkblue','login','jquery.fancybox.min','bootstrap-datepicker3.min','dropzone');
