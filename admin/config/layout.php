...
$config['layout']['default']['javascripts'] = array('jquery.min','bootstrap.min','metronic','layout','jquery.fancybox.min','function','bootstrap-datepicker.min','dropzone');
$config['layout']['default']['stylesheets'] = array('bootstrap.min','font-awesome.min','components','layout','darkblue','login','jquery.fancybox.min','bootstrap-datepicker3.min','dropzone','custom');
