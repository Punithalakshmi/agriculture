        ...
        <body>
            ...
            <div id="index-banner" class="parallax-container">
                <div class="section no-pad-bot">
                    <div class="container">  
                    <!-- <br><br> -->
                        <h1 class="header center teal-text text-lighten-2">Explore The Worldwide Farmers</h1>
                        <div class="row center home-search">
                            <form class="col s12">
                                <div class="col l6 s12">
                                  <input type="search" placeholder="Type Location and Keyword" aria-label="Search through site content">
                                </div>
                                <div class="col l6 s12">
                                  <input type="search" placeholder="Type Location and Keyword" aria-label="Search through site content">
                                </div>
                        ...
                        <div class="row center">
                            <a href="#" id="download-button" class="btn-large waves-effect waves-light lgreen lighten-1">Search</a>
                        </div>
                    <!-- <br><br> -->
                    </div>
                </div>
            ...
            <div class="farmers-list">
                <h1 class="center">Explore The Worldwide Farmers</h1>
                <div class="row center">
            ...
            <div class="top-footer">
                <div class="row">
                  <div class="col m6 s12 whats-new-wrap feed-e-height">
                      ...
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Laboriosam quasi reprehenderit consequuntur laborum veritatis odit ducimus aspernatur, incidunt voluptates suscipit, nemo eos temporibus dolores sequi dolorem ratione quae unde, rem.
                  </div>
                  <div class="col m6 s12 events-wrap feed-e-height">
                      <h3 class="custom-title no-decoration events-icon"><span>Events</span></h3>
                      Lorem ipsum dolor sit amet, consectetur adipisicing elit. Modi ea nobis illo labore aut in, doloribus facilis deserunt est adipisci suscipit voluptatibus molestiae aperiam officiis dolorum quos quasi at aliquid veritatis! Laudantium placeat numquam consectetur nostrum est molestiae sunt quis blanditiis velit ipsa explicabo distinctio nesciunt aperiam natus delectus temporibus, minus maxime quam nemo, asperiores quod et. Praesentium eos placeat fugit iure, corporis temporibus quos, expedita tempora libero optio quaerat quidem non illo commodi nostrum a ut blanditiis voluptatibus laborum!
                  </div>  
                </div>
            </div>
