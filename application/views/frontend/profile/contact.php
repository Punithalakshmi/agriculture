...
['name' => 'country_id', 'id' => 'country_id', 'tabindex' => '7']); ?> 
  </div>
...
<?php echo form_error('state_id', '<small class="help-block text-danger">&nbsp;', '</small>'); ?>
  ...
  <p>
    ...
    <button type="button" onclick="tab_view('contact','profile/update_contact','formContact')" class="btn-large z-depth-0" name="seller_data">Submit</button>
